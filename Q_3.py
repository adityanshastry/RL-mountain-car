...
def main(args):
    ...
    if args == "1":
        ...
        sarsa_results = Parallel(n_jobs=20)(
        ...
        print "Q-Learning"
        trial_ranges = Utils.get_trial_splits(total_trials)
        q_learning_results = Parallel(n_jobs=20)(
        ...
        sarsa_results = np.loadtxt("sarsa_rewards_2.txt")
        q_learning_results = np.loadtxt("q_learning_rewards_2.txt")
